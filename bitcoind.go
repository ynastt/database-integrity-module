...
// GetRawTransactionUPD returns raw transaction representation for given transaction id. RESULT IS A RawTransaction struct
func (b *Bitcoind) GetRawTransactionUPD(txId string, verbose bool) (rawTx RawTransaction, err error) {
	intVerbose := 0
	if verbose {
		intVerbose = 1
	}
